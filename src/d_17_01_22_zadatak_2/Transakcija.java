...
public class Transakcija {
	...
	public void izvrsiTransakciju(int vrednost) {
		if (this.racunSaKog.getTrenutnoStanje() - vrednost - this.vratiProviziju(vrednost) > 0) {
			...
			System.out
					.println("Racuna sa: " + this.racunSaKog.getImeIPrezime() + " " + this.racunSaKog.getBrojRacuna());
			System.out.println(this.racunSaKog.promeniStanje(vrednost) - this.vratiProviziju(vrednost));

			System.out
					.println("Racun na: " + this.racunNaKoji.getImeIPrezime() + " " + this.racunNaKoji.getBrojRacuna());
			System.out.println(this.racunNaKoji.promeniStanje(-vrednost)); // dodajem mu na ovaj nacin
		} else {
